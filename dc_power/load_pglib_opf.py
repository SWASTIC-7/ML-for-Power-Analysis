# Taken directly from: https://github.com/leonlan/pglib-opf-pyparser/tree/master


"""The script load_pglib_opf reads a power network instance from pglib-opf [1]. It takes as input a pglib_opf_*.m file and returns a pandas DataFrame for three tables:
